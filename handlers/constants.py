...
# Новые сообщения для прогноза
FORECAST_HEADER = "📈 Прогноз на 7 дней (линейный тренд):"
FORECAST_SALES = "💰 Прогноз продаж: {:.0f} (среднедневной прирост {:.0f})"
FORECAST_PROFIT = "📈 Прогноз прибыли: {:.0f} (среднедневной прирост {:.0f})"